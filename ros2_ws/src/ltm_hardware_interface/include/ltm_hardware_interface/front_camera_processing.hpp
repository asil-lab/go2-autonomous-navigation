...
#ifndef LTM_HARDWARE_INTERFACE__FRONT_CAMERA_PROCESSING_HPP_
#define LTM_HARDWARE_INTERFACE__FRONT_CAMERA_PROCESSING_HPP_
...
#endif  // LTM_HARDWARE_INTERFACE__FRONT_CAMERA_PROCESSING_HPP_