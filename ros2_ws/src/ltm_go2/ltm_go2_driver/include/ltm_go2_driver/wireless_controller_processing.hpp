...
#define WIRELESS_CONTROLLER_PROCESSING_NODE_NAME "cmd_vel_processing_node"

#define WIRELESS_CONTROLLER_PROCESSING_SUB_TOPIC "cmd_vel"
#define WIRELESS_CONTROLLER_PROCESSING_SUB_QUEUE_SIZE 10
