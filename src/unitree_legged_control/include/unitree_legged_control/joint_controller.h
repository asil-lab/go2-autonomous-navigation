...
namespace unitree_legged_control
{
    ...
    private:
        ...
        rclcpp::Subscription<unitree_legged_msgs::msg::MotorCmd>::SharedPtr sub_ft;
    ...
    public:
        ...
        ~UnitreeJointController();
        virtual bool init(hardware_interface::EffortJointInterface *robot, std::shared_ptr<rclcpp::Node> node);
